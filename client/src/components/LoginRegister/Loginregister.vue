            ...
            <div class="pa-6 whole_pane">
              <v-window v-model="page">
                <v-window-item :value="1">
                  <v-row>
                    <v-col class="login_pane pl-6 pt-6 pb-6" cols="12" md="8">
                    ...
                    >
                      ...
                      <v-stepper v-model="e6" vertical>
                            ...
                            <v-slide-x-transition>
                              ...
                              >
                                <v-text-field
                                  ...
                                  :append-icon="
                                    show_secret_key ? 'mdi-eye' : 'mdi-eye-off'
                                  "
                        ...
                        <v-stepper-content step="3">
                          <v-card color="#faf3e0" class="mb-12 p-3">
                            <p class="checkAcc">
                              Username : {{ username_register }}
                            </p>
                            <p class="checkAcc">
                              Name : {{ fname_register + " " + lname_register }}
                            </p>
                            <p class="checkAcc">Email : {{ email_register }}</p>
                            <p class="checkAcc">
                              Mobile Number : {{ tel_register }}
                            </p>
                            <p class="checkAcc">
...
export default {
  ...
  data: () => ({
    ...
    usernameRules: [
      ...
      (v) =>
        /^(\w|\d)+$/.test(v) ||
        "Username must contain only letter or number only",
    ...
    selectRules: [(v) => !!v || "Please select gender"],
    addressRules: [(v) => !!v || "Address is required"],
    selectRoleRules: [(v) => !!v || "Please select role"],
    secretKeyRules: [(v) => !!v || "Please enter secret key"],
    manageByRules: [(v) => !!v || "Please enter Manager ID"],
